...
public class FavouriteStatusAdapter extends RecyclerView.Adapter<FavouriteStatusAdapter.ViewHolder> {
    ...
    public FavouriteStatusAdapter(List<HaptoData> memberList, int rowLayout, Context context) {
    ...
    @Override
    public FavouriteStatusAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new FavouriteStatusAdapter.ViewHolder(v);
    }
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(final FavouriteStatusAdapter.ViewHolder viewHolder, int i) {
    ...
    private void deleteStatus(int adapterPosition) {
        ...
        db.deleteFavouriteStatus(hdd.getStatusID());
